      ...
      {!loading && user && (
        <div className="flex items-center gap-2 ml-auto">
          ...
          <div className="relative" ref={menuRef}>
            <IconBtn onClick={() => setMenuOpen(o => !o)} label="Więcej">
          ...
          {/* Avatar */}
          <div className="w-9 h-9 rounded-full bg-slate-900 dark:bg-slate-600 text-white flex items-center justify-center text-xs font-bold">
            {initials(user)}
          </div>
        </div>
      )}
