...
export function GeorgiaImportCustomsTemplate({ data }) {
  ...
  return (
    <div style={{ width: '794px', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '8px', color: '#000', backgroundColor: '#fff', boxSizing: 'border-box', padding: '8px 10px' }}>
      ...
      <div style={{ border: b, padding: '8px 12px', backgroundColor: '#1a3a6b' }}>
        <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#fff', letterSpacing: '1px' }}>GEORGIA — CUSTOMS DECLARATION</div>
        <div style={{ fontSize: '8px', color: '#a0b8d8', marginTop: '2px' }}>Revenue Service of Georgia</div>
        <div style={{ fontSize: '6.5px', color: '#a0b8d8', marginTop: '1px' }}>System: e-Customs Georgia / ASYCUDA</div>
      </div>
      ...
      <div style={{ borderLeft: b, borderRight: b, borderTop: b, padding: '4px 6px', backgroundColor: '#fffbe6' }}>
        <span style={{ fontSize: '6.5px', color: '#666' }}>
          <strong>WAŻNE:</strong> Gruzja ma jedne z najniższych ceł na świecie (śr. 0.6%). DCFTA z UE — zerowe cła dla
          towarów unijnych. TIN importera wymagany. Czas odprawy: 1-3 dni.
        </span>
      </div>

      {/* TIN | DECLARATION NO. | CUSTOMS POST */}
