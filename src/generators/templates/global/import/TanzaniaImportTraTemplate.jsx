...
export function TanzaniaImportTraTemplate({ data }) {
  ...
  return (
    <div style={{ width: '794px', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '8px', color: '#000', backgroundColor: '#fff', boxSizing: 'border-box', padding: '8px 10px' }}>
      ...
      <div style={{ border: b, padding: '8px 12px', backgroundColor: '#1a3a6b' }}>
        <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#fff', letterSpacing: '1px' }}>TANZANIA — CUSTOMS BILL OF ENTRY</div>
        <div style={{ fontSize: '8px', color: '#a0b8d8', marginTop: '2px' }}>Tanzania Revenue Authority — TRA / Tanzania Customs</div>
        <div style={{ fontSize: '6.5px', color: '#a0b8d8', marginTop: '1px' }}>System: TANCIS — Tanzania Customs Integrated System</div>
      </div>
      ...
      <div style={{ borderLeft: b, borderRight: b, borderTop: b, padding: '4px 6px', backgroundColor: '#fffbe6' }}>
        <span style={{ fontSize: '6.5px', color: '#666' }}>
          <strong>WAŻNE:</strong> TIN importera wymagany. Tanzania należy do EAC (East African Community) — preferencje
          celne wewnątrzregionalne. WTO IDF levy 2%. Czas odprawy: 5-14 dni.
        </span>
      </div>

      {/* TIN | BOE NO. | CUSTOMS STATION */}
