...
export function UzbekistanImportCustomsTemplate({ data }) {
  ...
  return (
    <div style={{ width: '794px', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '8px', color: '#000', backgroundColor: '#fff', boxSizing: 'border-box', padding: '8px 10px' }}>
      ...
      <div style={{ border: b, padding: '8px 12px', backgroundColor: '#1a3a6b' }}>
        <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#fff', letterSpacing: '1px' }}>UZBEKISTAN — ТАМОЖЕННАЯ ДЕКЛАРАЦИЯ — ГТД</div>
        <div style={{ fontSize: '8px', color: '#a0b8d8', marginTop: '2px' }}>Государственный таможенный комитет — ГТК</div>
        <div style={{ fontSize: '6.5px', color: '#a0b8d8', marginTop: '1px' }}>System: ASYCUDA World / SINGLE WINDOW Uzbekistan</div>
      </div>
      ...
      <div style={{ borderLeft: b, borderRight: b, borderTop: b, padding: '4px 6px', backgroundColor: '#fffbe6' }}>
        <span style={{ fontSize: '6.5px', color: '#666' }}>
          <strong>WAŻNE:</strong> INN importera obowiązkowy. Uzbekistan nie należy do EAEU. Szybko rozwijający się
          rynek — reformy celne od 2017. Czas odprawy: 3-7 dni.
        </span>
      </div>

      {/* INN | GTD NO. | CUSTOMS POST */}
      <div style={{ display: 'flex', borderLeft: b, borderRight: b, borderTop: b }}>
        <div style={{ flex: 1, padding: '3px 5px', borderRight: b, minHeight: '22px' }}>
          <div style={lbl}>INN importera:</div>
          <div style={val}>{data.customs?.eori || ''}</div>
        </div>
        <div style={{ flex: 1, padding: '3px 5px', borderRight: b, minHeight: '22px' }}>
          <div style={lbl}>GTD No.:</div>
